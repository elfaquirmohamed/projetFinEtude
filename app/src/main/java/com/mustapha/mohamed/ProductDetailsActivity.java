        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    productName.setText(menu.getPname());
                    productPrice.setText(menu.getPrice());
                    productDescription.setText(menu.getDescription());
                    Picasso.get().load(menu.getImage()).into(productImage);
                }
            }
